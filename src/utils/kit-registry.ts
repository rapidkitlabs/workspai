...
export const KIT_REGISTRY: KitDefinition[] = [
  ...
  },
  {
    ...
    createUsage:
      'rapidkit create project springboot.standard <name> [--java-version <major>] [--spring-boot-version <semver>] [--group-id <com.example>] [--package-name <com.example.app>] [--port <number>]',
  },
  {
    id: 'gofiber.standard',
    ...
    stability: 'stable',
    generator: 'gofiber',
    createUsage: 'rapidkit create project gofiber.standard <name> [--output <dir>]',
  },
  {
    id: 'gogin.standard',
    ...
    stability: 'stable',
    generator: 'gogin',
    createUsage: 'rapidkit create project gogin.standard <name> [--output <dir>]',
  },
  {
    ...
    createUsage:
      'rapidkit create project dotnet.webapi.clean <name> [--target-framework net8.0] [--root-namespace <Company.Product>] [--port <number>]',
  },
];

# Workspai CLI v0.42.0 Release Notes

**Release Date:** July 6, 2026

## Overview

Workspai CLI v0.42.0 makes Workspace Intelligence usable without forcing every
...
```bash
npx workspai create workspace my-wsp --profile polyglot --skip-python-engine --yes
cd my-wsp
...
```bash
npx workspai@0.42.0 --version --json
```
